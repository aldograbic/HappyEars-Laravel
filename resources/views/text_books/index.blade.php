    ...
    <main>
        <div class="stage main position-absolute top-50 start-50 translate-middle">
            <div class="stories position-absolute top-0 end-0 ps-5 border-start">
                <a style="margin-left: 85%;" href="{{ route('profile-page') }}"><img class="profile-image" src="{{ Auth::user()->profile_image }}"></a>
                
                <form class="position-absolute top-50 start-50 translate-middle" style="display:flex; flex-direction:column; align-items: center;" method="POST" action="{{ route('text_books.store') }}">
                    @csrf
            ...
            <div class="stories-main position-absolute top-0 start-0 ps-5 overflow-y-auto" id="stories">
                ...
                <div class="stories-story pt-3 border-bottom">
                    ...
                    <a class="position-absolute end-0 mt-5 me-5 translate-middle-y" href="{{ route('text_books.show', ['story' => $story->id]) }}"><img src="img\icons8-play-button-circled-50.png"></a>
                </div>
                @endforeach
            </div> 
