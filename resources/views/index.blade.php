...
<body>
    ...
    <main>
        <div class="stage main position-absolute top-50 start-50 translate-middle">
            <div class="hello position-absolute top-0 start-50 translate-middle-x mt-5">
                <h1><span style="font-size: x-large;">Hello</span> <br> <span style="color: #FED24D;">{{ Auth::user()->first_name }}</span></h1>
                <a href="{{ route('profile-page') }}"><img src="{{ Auth::user()->profile_image }}" style="width: 7vw;"></a>
            </div>
    ...
    <div class="container">
        ...
        <div class="stage position-absolute top-50 start-50 translate-middle" id="stage3" style="display: none;">
            ...
            <a href="{{ route('registration-page') }}" class="btn">NO</button>
            <a href="{{ route('login-page') }}" class="btn">YES</button>
        </div>
    </div>
    @endif
