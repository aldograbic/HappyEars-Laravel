...
<body>
    ...
    <main>
        <div class="stage main position-absolute top-50 start-50 translate-middle">
            <a href="<?php echo e(route('audiobooks-page')); ?>" class="arrow position-absolute top-0 start-0 pe-3 ps-3 mt-4" style="text-decoration: none" id="backButton">Back</a>
            <p class="text-decoration-underline mt-3" style="color: #FED24D"><?php echo e($story->title); ?></p>
            <div class="position-absolute top-50 start-50 translate-middle">
                <img class="img-fluid" style="width: 50vw;" src="<?php echo e(asset('img\bunny-holding-player.png')); ?>">
                <audio controls class="position-absolute top-50 start-50 translate-middle mt-5">
                    <source src="<?php echo e(Storage::url($story->audio)); ?>" type="audio/mpeg">
...
</html><?php /**PATH C:\Users\Korisnik\OneDrive\Dokumenti\projekti\HappyEars (Laravel)\resources\views/audio_books/story.blade.php ENDPATH**/ ?>